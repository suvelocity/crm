...
export default function QuizSubmissionByStudent(props: IProps) {
    const id = props.id;
    ...
    useEffect(() => {
        const fetchQuizzesSubmissons = async () => {
          try {
            const quizSubmissions: QuizSubmission[] = (await network.get(`/api/v1/fieldsubmission/bystudent/${id}/full`)).data;
